                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('dashboard.employees.update',$employee -> id)}}"
                                              method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$employee -> first_name}}" id="first_name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="first_name">
                                                            @error("first_name")
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$employee -> last_name}}" id="last_name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="last_name">
                                                            @error("last_name")
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput2"> أختر الشركة </label>
